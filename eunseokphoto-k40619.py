...
# ================== 配置 ==================
CSV_FILE = "eunseokphoto.csv"  # CSV 文件名
GITHUB_REPO = "yuiki001/eunseokphoto-k40619"        # 请替换为您的仓库名
GITHUB_BRANCH = "main"                          # 分支名（main 或 master）
# GitHub Personal Access Token 优先从环境变量 GITHUB_TOKEN 读取

# 商品URL和地址名称映射
product_urls = {
    "https://www.ktown4u.com/iteminfo?goods_no=164310": "国际地址",
    "https://cn.ktown4u.com/iteminfo?goods_no=164310": "中国地址",
    "https://kr.ktown4u.com/iteminfo?goods_no=164310": "韩国地址",
    "https://jp.ktown4u.com/iteminfo?goods_no=164310": "日本地址",
}
